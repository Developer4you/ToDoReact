...
test('correct task should be added to correct array', () => {
    const newModel = { id: "0", title: "juce", status: TaskStatuses.New, todoListId: "todolistId2", description:'',
        startDate:'', deadline:'', addedDate:'', order: 0, priority: TaskPriorities.Low}
    const action = addTaskAC(newModel);
...
test('status of specified task should be changed', () => {
    const newModel =  { id: "2", title: "milk", status: TaskStatuses.New, todoListId: "todolistId2",
        description:'', startDate:'', deadline:'', addedDate:'', order: 0, priority: TaskPriorities.Low}
    const action = updateTaskAC("2", newModel, "todolistId2");
...
test('title of specified task should be changed', () => {
    const newModel =  { id: "2", title: "yogurt", status: TaskStatuses.New, todoListId: "todolistId2",
        description:'', startDate:'', deadline:'', addedDate:'', order: 0, priority: TaskPriorities.Low}
    const action = updateTaskAC("2", newModel, "todolistId2");
...
test('emply arrays shold be added when we set todolists', () => {
