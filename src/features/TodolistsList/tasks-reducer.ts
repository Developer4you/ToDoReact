...
export const addTaskTC = (title: string, todolistId: string) => (dispatch: Dispatch<TasksActionsType | AppActionsType | AppActionsType>) => {
    dispatch(setAppStatusAC('loading'))
...
export const updateTaskTC = (taskId: string, domainModel: UpdateDomainTaskModelType, todolistId: string) =>
    (dispatch: Dispatch<TasksActionsType | AppActionsType>, getState: () => AppRootStateType) => {
        ...
        if (!task) {
            //throw new Error("task not found in the myTests");
            console.warn('task not found in the myTests')
            return
        }
